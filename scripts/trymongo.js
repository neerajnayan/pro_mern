// All calls to MongoDB driver are asynchronous calls.
// There are four different paradigms for dealing with
// the asynchronous nature:
// 1. The callback paradigm
// 2. Using promises
// 3. Co module and genertor function
// 4. async module
...
testWithCallbacks() {
    MongoClient.connect('mongodb://localhost/playground', function(err, db) {
        db.collection('employees')
            .insertOne({id: 1, name: 'A. Callback'},
                function(err, result) {
...
// You must install co module, in order to use this paradigm.
// npm install co
testWithGenerator() {
    const co = require('co');
    co(function*() {
...
// You must install async module, in order to use this paradigm.
// npm install async
testWithAsync() {
